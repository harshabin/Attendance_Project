...
@section('content')
   <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View SMTP</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="">Home</a></li>
              <li class="breadcrumb-item active">View SMTP</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                                    ...
                                    <form class="form-horizontal" id="form1">
                                      <div class="card-body">
                                        <div class="form-group row">
                                          <label for="name" class="col-sm-4 col-form-label">Host *</label>
                                          <div class="col-sm-8">
                                           <input type="text" class="form-control" name="host" placeholder="Host" value="{{$data[0]->host}}"/> 
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <label for="birth" class="col-sm-4 col-form-label">Port *</label>
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control" name="port" placeholder="URL" required value="{{$data[0]->port}}">
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <label for="birth" class="col-sm-4 col-form-label">User name *</label>
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control" name="user_name" placeholder="URL" required value="{{$data[0]->user_name}}">
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <label for="birth" class="col-sm-4 col-form-label">Passwword *</label>
                                          <div class="col-sm-8">
                                            <input type="password" class="form-control" name="password" placeholder="URL" required value="{{$data[0]->password}}">
                                          </div>
                                        </div>
...
$("#submit").click(function(e){
    ...
    $.ajax({
      url:"{{route('settings.smtp_update')}}",
      data:formData,
      dataType:"json",
      type:"POST",
       processData: false,
