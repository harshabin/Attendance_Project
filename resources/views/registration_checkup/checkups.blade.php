            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">{{$data[0]->name}}({{$data[0]->mobile_number}})</h3>
                      <div class="add-btn">
                        ...
                        <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="card card-info">
                                    <div class="card-header">
                                      <h3 class="card-title">Chckups</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form class="form-horizontal" id="form1">
                                      <div class="card-body">
                                        ...
                                        <div class="form-group row" >
                                          <label for="birth" class="col-sm-4 col-form-label">Checkup Date</label>
                                          <div class="col-sm-8">
                                            <input type="date" class="form-control" name="checkup_date" placeholder="Checkup Date"  value="<?php echo $date;?>">
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <label for="name" class="col-sm-4 col-form-label">Doctor Name </label>
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control" name="doctor_name" placeholder="Doctor Name" >
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                          <label for="mobile" class="col-sm-4 col-form-label">Remarks</label>
                                          <div class="col-sm-8">
                                        ...
                                        <div class="form-group" style="display: flex;gap: 1rem; flex-wrap: wrap;">
                                          @foreach($checkups as $dt)
                                            ...
                                            <div class="custom-control custom-checkbox">
                                              ...
                                              value="{{$dt->name}}">
                                              <label for="customCheckbox{{$dt->id}}" class="custom-control-label">{{$dt->name}}</label> 
                                            </div>
                                            @endforeach
...
$("#submit").click(function(e){
 ...
 $(this).attr("disabled",true)
    ...
    $.ajax({
      url:"{{route('registration_checkup.add_checkups')}}",
      data:formData,
      dataType:"json",
      type:"POST",
       processData: false,
...
$('.modal').modal('show');
 $("#submit").removeAttr("disabled")
      ...
      },error:function(data){ $("#submit").removeAttr("disabled")
...
$("#table3").DataTable({
    ...
    "search": ''
        ...
        "ajax": {
           ...
           url:"{{route('registration_checkups.get_checkups_history')}}", 
   dataType:"JSON",
   type:"get",
   data:{patient_id:"{{$data[0]->id}}"},
        ...
        return_data.push({
          ...
          'id':k++,
           "created_on":data[i].checkup_date,
        ...
        "action":"<a href='../delete_checkups/"+id+"' onclick='return func()'><button class='view btn btn-primary' value='"+id+"'>Delete</button></a>&nbsp;"
        ,
    ...
    //$("#table11_filter").find("input").css({"width":"700px","margin-left":"-50%"});
       $("#table3_filter").find("input").attr("placeholder","Search ");
      return return_data;
       },
       error:function(xhr){
