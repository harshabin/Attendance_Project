...
--
-- Host: localhost:3306
-- Generation Time: Aug 08, 2022 at 12:25 AM
...
-- Procedures
--
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `add_checkup` (IN `input_data` JSON, IN `checkup_non_routine` JSON)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `add_checkups_history` (IN `input_data` JSON)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `add_registration` (IN `checkup` JSON, IN `input_data` JSON)  BEGIN
DECLARE i INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
DECLARE id INT DEFAULT 0;
set @name=JSON_UNQUOTE(JSON_EXTRACT(input_data,'$[0].name'));
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `add_sms_settings` (IN `input_data` JSON)  BEGIN
DECLARE i INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
DECLARE id INT DEFAULT 0;
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `add_users` (IN `input_data` JSON)  BEGIN
DECLARE i INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
DECLARE id INT DEFAULT 0;
set @name=JSON_UNQUOTE(JSON_EXTRACT(input_data,'$[0].name'));
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `check_for_unique_checkup` (IN `input_data` JSON, IN `checkup_non_routine` JSON)  BEGIN
DECLARE i INT DEFAULT 0;
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `check_for_unique_checkup_id` (IN `input_data` JSON)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `delete_checkup` (IN `id1` INT)  BEGIN
DELETE from checkup where id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `delete_checkups_history` (IN `id1` INT)  BEGIN
delete from checkups_history where id=id1;

END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `delete_registration` (IN `id1` TEXT)  BEGIN
DELETE from registration where id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `delete_users` (IN `id1` INT)  BEGIN
DELETE from users where id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `disable_checkup` (IN `id1` INT, IN `status1` TEXT)  BEGIN
update checkup set status=status1 where id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `disable_registration` (IN `id1` TEXT, IN `status1` TEXT)  BEGIN
update registration set status=status1 where id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `disable_users` (IN `id1` INT, IN `status1` TEXT)  BEGIN
update users set status=status1 where id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `fetch_checkup` (IN `checkup_type` TEXT)  BEGIN
select * from checkup where type=checkup_type and status="active";
end$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `fetch_checkup_other` (IN `checkup_type` TEXT)  BEGIN
select * from checkup where type!=checkup_type and STATUS="active";
end$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `fetch_routine_non_routine` (IN `id1` INT)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_all_menus` ()  BEGIN
select * from menus;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_all_users` (IN `term` TEXT)  BEGIN
select * from users where role<>"admin" and name  LIKE CONCAT('%', term , '%') ;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_checkups_history` (IN `index1` INT, IN `length` INT, IN `search` TEXT, IN `id1` INT)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_checkups_history_cron` (IN `id1` INT, IN `chk_id` INT)  BEGIN
select * from checkups_history where registration_id=id1 and checkup=chk_id ; 


END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_checkup_cron` (IN `id1` TEXT)  BEGIN

select chkp.* from checkup chkp JOIN registered_for rf where chkp.id=rf.checkup_id and rf.registration_id=id1; 
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_checkup_non_routine_cron` (IN `id1` INT)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_master_vaccination` (IN `index1` INT, IN `length` INT, IN `search` TEXT, IN `type1` TEXT)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_master_vaccination_id` (IN `id1` INT)  BEGIN
select * from checkup where id=id1;

END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_master_vaccination_total` (IN `type1` TEXT, IN `search` TEXT)  BEGIN
if type1 ="vaccination" then
if search is null then
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_registrations` (IN `index1` INT, IN `length` INT, IN `search` TEXT, IN `type` TEXT)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_registrations_id` (IN `id1` TEXT)  BEGIN
 SELECT * from registration where id=id1;

END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_registrations_total` (IN `type` TEXT, IN `search` TEXT)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_registration_cron` ()  BEGIN
   SELECT * from registration where STATUS="active";


END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_registration_for_id` (IN `id1` TEXT)  BEGIN
SELECT checkup.*
from registered_for join checkup where checkup.id=registered_for.checkup_id and registration_id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_sms_details` ()  BEGIN
select * from sms_settings;

END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_smtp_settings` ()  BEGIN
select * from smtp_settings;

END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_users` (IN `index1` INT, IN `length` INT, IN `search` TEXT)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_users_id` (IN `id1` INT)  BEGIN
SELECT * from users where id=id1;

END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `get_user_for_menu` (IN `id` TEXT)  BEGIN
SELECT * from users where user_name=id;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `query_login` (IN `user_name1` TEXT, IN `pwd1` TEXT)  BEGIN
select * from users where user_name=user_name1 and pwd=pwd1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `revert_sms_status_cron` ()  BEGIN

update registration set sms_status="active" where status="active";
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `sms_update` (IN `input_data` JSON)  BEGIN
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `smtp_update` (IN `input_data` JSON)  BEGIN
DECLARE success INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `test` (IN `input_data` TEXT)  NO SQL
BEGIN
select * from checkup;
end$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `update_checkup` (IN `input_data` JSON, IN `checkup_non_routine` JSON)  BEGIN
DECLARE success INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `update_checkup_routine` (IN `input_data` JSON, IN `checkup_non_routine` JSON)  BEGIN
DECLARE i INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `update_registration` (IN `checkup` TEXT, IN `input_data` TEXT)  BEGIN
DECLARE i INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `update_send_notification_cron` (IN `id1` INT, IN `date` TEXT)  BEGIN
update registration set notification_sent_on=date where id=id1;
END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `update_sms_status_cron` (IN `id1` INT)  BEGIN
update registration set sms_status="disabled" where id=id1;

END$$

CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `update_users` (IN `input_data` JSON)  BEGIN
DECLARE success INT DEFAULT 0;
DECLARE registration_id INT DEFAULT 0;
...
CREATE DEFINER=`avmultihospital`@`localhost` PROCEDURE `user_accessibility_update` (IN `data` JSON, IN `user` TEXT)  BEGIN
...
(2, 'qqq', 'non_routine', 0, 0, 0, 0, 0, NULL, '2022-08-08 09:51:56', '', '2022-08-08 09:51:56', 'active', 0);
...
(1, '', '2022-08-08', '', '', '', NULL, NULL, '2022-08-08 09:48:07', '', 'vaccination', NULL, 'active', '0', '2022-08-08 00:00:00', 'active');
...
(8, 'Jagadish Kumar TR', 'jagadish', '12345', '99021286491', 'Raghavendra Nagar,Kuvempu Road\r\nNear Settihalli Gate TUMKUR-572149', 'receptionist', '2022-08-03 02:57:09', '2022-08-03 02:57:25', 'active', '[{\"menu\": \"Dashboard\"}, {\"menu\": \"Vaccination Registration\"}, {\"menu\": \"Routine checkup\"}, {\"menu\": \"Routine Check-up Registration\"}]'),
(9, 'Mindroit Pavankumar 1', 'pavan5432', '123456789', '8660102627', 'Bangalore', 'receptionist', '2022-08-03 03:32:11', '2022-08-04 06:05:13', 'active', '[{\"menu\": \"Vaccination Registration\"}, {\"menu\": \"Routine checkup\"}, {\"menu\": \"Routine Check-up Registration\"}]');
