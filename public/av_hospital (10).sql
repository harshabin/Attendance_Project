...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2022 at 04:21 AM
...
if search!='' then
select *  from registration where registration_type=type and (mobile_number LIKE CONCAT('%', search , '%') or name LIKE CONCAT('%', search , '%')) order by id desc
 limit index1 ,length;
end if;
...
update sms_settings set text=@text, checkup_text=@checkup_text,url=@url where id=@ids;
...
(1, 'Cancer', 'routine', NULL, 1, 1, 0, 0, 'null', '2022-08-06 06:27:01', 'jagadish', '0000-00-00 00:00:00', 'active', NULL),
(2, 'injury', 'non_routine', NULL, 90, 0, 0, 0, 'null', '2022-08-06 07:06:17', 'jagadish', '0000-00-00 00:00:00', 'active', NULL);
...
CREATE TABLE `checkups_history` (
  ...
  `doctor_name` int(11) DEFAULT NULL,
  `created_on` datetime NOT NULL,
  `created_by` varchar(200) NOT NULL,
...
(1, 1, 1, '2022-08-06 06:32:42', 'jagadish', 1, '1', NULL, '2022-08-06'),
(2, 2, 1, '2022-08-06 07:23:36', 'jagadish', 2, '1', NULL, '2022-08-06');
...
(1, 2, 1, 1, 1, 1, '2022-08-06 07:06:17');
...
(3, 2, 1, NULL, '2022-08-06 07:21:13'),
(4, 2, 2, NULL, '2022-08-06 07:21:13');
...
(1, 'Jagadish Kumar TR', '0000-00-00', '9902128649', 'jagu123.indian@gmail.com', 'Raghavendra Nagar,Kuvempu Road', 572102, 'null', '2022-08-06 06:27:34', 'jagadish', 'checkup', NULL, 'active', '0', NULL),
(2, 'Jagadish Kumar TR', '0000-00-00', '9902128649', 'jagu123.indian@gmail.com', 'Raghavendra Nagar,Kuvempu Road', 572102, 'null', '2022-08-06 07:19:39', 'jagadish', 'checkup', '2022-08-06 07:21:13', 'active', '0', NULL);
...
(1, 'Dear Parent, your child\'s {#var#} vaccination is due by {#var#}. For appointment please call {#var#}. AV Multispeciality Hospital', 'http://login.redsms.in/api/smsapi?key=b27765340d7e5c797d5f754ce22f1254&route=2&sender=AVHSPT&number={#number}&sms={#message}&templateid=DLT_Templateid', '', '2022-08-03 10:35:20', NULL, 'Dear {#var#}, your {#var#} Checkup is due by {#var#}. For appointment please call {#var#}. AV Multispeciality Hospital');
...
(1, 'surgery', 'jagadish', '12345', '0', '11', 'admin', '2019-09-09 20:19:29', NULL, 'active', NULL),
(5, 'Jagadish Kumar TR', 'admin1', '12345', '9902128649', 'Raghavendra Nagar,Kuvempu Road\r\nNear Settihalli Gate TUMKUR-572102\r\n9902128649', 'receptionist', '2022-08-03 12:55:25', NULL, 'active', '[{\"menu\":\"Dashboard\"},{\"menu\":\"Vaccination Registration\"}]');
